...
class AdminRestControllerTest extends AbstractControllerTest {
    ...
    void getWithMeal() throws Exception {
        String json = perform(MockMvcRequestBuilders.get(REST_URL+"/with-meals/"+admin.getId()))
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin))
        ...
        MealTestData.MEAL_MATCHER.assertMatch(jsonMeals, List.of(MealTestData.adminMeal2, MealTestData.adminMeal1));
    }
}